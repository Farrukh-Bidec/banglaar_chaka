    ...
    <section className="py-10 sm:py-12 px-4 sm:px-6 md:px-10 lg:px-12 xl:px-16 flex justify-center font-sans">
      <div className="max-w-7xl w-full">
        ...
        <div className="flex justify-between items-end mb-6">
          <h2 className="text-[22px] font-semibold text-[#434343]">{t("Popular New Bikes")}</h2>
          <button className="text-[#3b6598] text-[14px] hover:underline">{t("View All New Bikes")}</button>
        </div>
      ...
      `}>
          ...
          `}
              style={{
               ...
               transform: isDesktop ? `translateX(-${currentIndex * 25}%)` : 'none',
